...
<section id="customer" class="container">
            ...
            <div class="card profile-card-2">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="icon-block float-right">
                        <router-link class="btn btn-outline-info" :to="{name:'customer', params:{id: customer.id}}">
                            View customer
                        </router-link>
                    </div>
                </div>
    ...
    <div class="mt-4 text-center">
        <pagination :limit='21' align="center" :data="customers" @pagination-change-page="getCustomers"></pagination>
    </div>
    </div>
</section>
</template>
